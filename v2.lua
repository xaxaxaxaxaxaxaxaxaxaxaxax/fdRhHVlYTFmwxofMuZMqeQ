...
do
    ...
    Aiming:List({
        ...
        Default = getgenv().Extort['Target Part'],
        Callback = function(Value)
            getgenv().Extort['Target Part'] = Value
        end
    })
    ...
    Aiming:Textbox({
        Name = "Prediction",
        Flag = "Prediction",
        Default = tostring(getgenv().Extort.Prediction.Amount),
        Callback = function(Value)
            getgenv().Extort.Prediction.Amount = tonumber(Value) or getgenv().Extort.Prediction.Amount
        end
    })
    ...
    Aiming:Textbox({
        Name = "Jump Offset",
        Flag = "JumpOffset",
        Default = tostring(getgenv().Extort.Offset.Jump),
        Callback = function(Value)
            getgenv().Extort.Offset.Jump = tonumber(Value) or getgenv().Extort.Offset.Jump
        end
    })
    ...
    Aiming:Toggle({
        ...
        Flag = "AutoPrediction",
        Default = getgenv().Extort['Auto Prediction'],
        Callback = function(Value)
            getgenv().Extort['Auto Prediction'] = Value
        end
    })
    ...
    Features:Toggle({
        Name = "Look At", 
        Flag = "LookAt",
        Default = getgenv().Extort.Features['Look At'],
        Callback = function(Value)
            getgenv().Extort.Features['Look At'] = Value
        end
    })
    ...
    Features:Toggle({
        Name = "Auto Air", 
        Flag = "AutoAir",
        Default = getgenv().Extort.Features['Auto Air'],
        Callback = function(Value)
            getgenv().Extort.Features['Auto Air'] = Value
        end
    })
    ...
    Features:Toggle({
        ...
        Default = getgenv().Extort.Features['Highlight Target'],
        Callback = function(Value)
            getgenv().Extort.Features['Highlight Target'] = Value
        end
    })
    ...
    Highlight:Colorpicker({
        Name = "Fill Color",
        Default = getgenv().Extort.Highlight.FillColor,
        Callback = function(Value)
            getgenv().Extort.Highlight.FillColor = Value
        end
    })

    Highlight:Colorpicker({
        Name = "Outline Color",
        Default = getgenv().Extort.Highlight.OutlineColor,
        Callback = function(Value)
            getgenv().Extort.Highlight.OutlineColor = Value
        end
    })
    ...
    Highlight:Textbox({
        ...
        Default = tostring(getgenv().Extort.Highlight.FillTransparency),
        Callback = function(Value)
            getgenv().Extort.Highlight.FillTransparency = tonumber(Value) or getgenv().Extort.Highlight.FillTransparency
        end
    })
    ...
    Highlight:Textbox({
        ...
        Default = tostring(getgenv().Extort.Highlight.OutlineTransparency),
        Callback = function(Value)
            getgenv().Extort.Highlight.OutlineTransparency = tonumber(Value) or getgenv().Extort.Highlight.OutlineTransparency
        end
    })
    ...
    Strafe:Toggle({
        Name = "Enabled", 
        Flag = "StrafeEnabled",
        Default = getgenv().Extort.Strafe.Enabled,
        Callback = function(Value)
            getgenv().Extort.Strafe.Enabled = Value
        end
    })
    ...
    Strafe:Textbox({
        Name = "Speed",
        Flag = "StrafeSpeed",
        Default = tostring(getgenv().Extort.Strafe.Speed),
        Callback = function(Value)
            getgenv().Extort.Strafe.Speed = tonumber(Value) or getgenv().Extort.Strafe.Speed
        end
    })
    ...
    Strafe:Textbox({
        Name = "Distance",
        Flag = "StrafeDistance",
        Default = tostring(getgenv().Extort.Strafe.Distance),
        Callback = function(Value)
            getgenv().Extort.Strafe.Distance = tonumber(Value) or getgenv().Extort.Strafe.Distance
        end
    })
    ...
    Strafe:Textbox({
        Name = "Height",
        Flag = "StrafeHeight",
        Default = tostring(getgenv().Extort.Strafe.Height),
        Callback = function(Value)
            getgenv().Extort.Strafe.Height = tonumber(Value) or getgenv().Extort.Strafe.Height
        end
    })
    ...
    CFrameWalk:Toggle({
        ...
        Default = getgenv().Extort['CFrame Walk'].Enabled,
        Callback = function(Value)
            getgenv().Extort['CFrame Walk'].Enabled = Value
        end
    })
    ...
    CFrameWalk:Textbox({
        ...
        Default = tostring(getgenv().Extort['CFrame Walk'].Speed),
        Callback = function(Value)
            getgenv().Extort['CFrame Walk'].Speed = tonumber(Value) or getgenv().Extort['CFrame Walk'].Speed
        end
    })
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/xaxaxaxaxaxaxaxaxaxaxaxax/fdRhHVlYTFmwxofMuZMqeQ/refs/heads/main/haha"))()
